...
const GroupList = () => {
  return (
    <Box boxShadow={4} sx={{height:"40vh", overflow:"auto", borderRadius:"10px"}}>
        <Box sx={{p:"15px", display:"flex", alignItems:"center", justifyContent:"space-between"}}><h3>Group List</h3><Button variant='outlined' size='small' color='warning'>Create Group</Button></Box>
        <Box sx={{display:"flex", alignItems:"center", justifyContent:"space-between",borderBottom:"1px solid red", p:"10px"}}>
            ...
            <Button size='small' variant='contained' color='error'>Join Group</Button>
        </Box>
    </Box>
  )
}
